...
void jet_flavour_0_4()
{
  ...
  auto df8 = df7.Define("SDFlav_Jets",[](std::vector<fastjet::PseudoJet>& Flav_Jets) {
			      ...
			      SDFlavourCalc sdFlavCalc(2.0, 0.1, 0.4);
 ...
 auto rdf = df20.Define("S_Flav_Dijets_M", [](const std::vector<fastjet::PseudoJet>& S_Flav_Jets){
  ...
  auto h1 = rdf.Histo1D({"pT", "Strange SDFlavour Dijet [R = 0.4]", 400u, 0., 400.}, "S_SDFlav_Dijets_Pt");
  auto h2 = rdf.Histo1D({"pT", "Strange Flavour Dijet [R = 0.4]", 400u, 0., 400.}, "S_Flav_Dijets_Pt");
  auto h3 = rdf.Histo1D({"phi", "Strange SDFlavour Dijet [R = 0.4]", 10u, 0., 10.}, "S_SDFlav_Dijets_Phi");
  auto h4 = rdf.Histo1D({"phi", "Strange Flavour Dijet [R = 0.4]", 10u, 0., 10.}, "S_Flav_Dijets_Phi");
  auto h5 = rdf.Histo1D({"eta", "Strange SDFlavour Dijet [R = 0.4]", 10u, 0., 10.}, "S_SDFlav_Dijets_Eta");
  auto h6 = rdf.Histo1D({"eta", "Strange Flavour Dijet [R = 0.4]", 10u, 0., 10.}, "S_Flav_Dijets_Eta");
  auto h7 = rdf.Histo1D({"M", "Strange SDFlavour Dijet [R = 0.4]", 300u, 0., 300.}, "S_SDFlav_Dijets_M");
  auto h8 = rdf.Histo1D({"M", "Strange Flavour Dijet [R = 0.4]", 300u, 0., 300.}, "S_Flav_Dijets_M");
auto h9 = df11.Histo1D({"N", "Stange Flavour Jet [R = 0.4]", 10u, 0, 10}, "N_s_Flav_Jets");
auto h10 = df11.Histo1D({"N", "Stange SDFlavour Jet [R = 0.4]", 10u, 0, 10}, "N_s_SDFlav_Jets");
